...
<div class="col-sm-10 col-sm-offset-1">
    ...
    <div class="widget-box transparent">
        ...
        <div class="col-sm-4">
            <?php echo TbHtml::image(Yii::app()->baseUrl . '/images/Vitking_House_Logo.jpg','Company\'s logo',array('width'=>'110')); ?>
        </div>
        ...
        <div class="col-sm-4">
            ...
            <?php if (Yii::app()->settings->get('receipt', 'printcompanyAddress')=='1') { ?>  
                <div class="center">
                    <b class="red"><?php echo TbHtml::encode(Yii::app()->settings->get('site', 'companyAddress')); ?></b>
                </div>
            <?php } ?>
            <div id="sale_receipt" class="center"><?php echo 'អាហាសុខភាព'; ?></div>
            <div class="center"><?php echo TbHtml::encode(Yii::t('app','THE BEST VEGENATRIAN')) ?></div>
            <div class="center"><?php echo TbHtml::encode(Yii::t('app','FOR YOUR HEALTH')) ?></div>
        </div>
                        ...
                        <div align="right">
                            <ul class="list-unstyled spaced">
                                <li>
                                    ...
                                    <?php echo TbHtml::encode(Yii::t('app','Invoice ID') . " : " ); ?>
                                </li>
                                <li>
                                    <i class="ace-icon fa fa-caret-right green"></i>
                    ...
                    <table class="table table-striped table-bordered" id="receipt_items">
                        ...
                        <?php foreach($items as $id=>$item): ?>
                            ...
                            <tr>
                                ...
                                <?php } else { ?>
                                     <td class="center"><span class="text-info"><?php echo $item['name']; ?></span></td>
                                <?php } ?>
