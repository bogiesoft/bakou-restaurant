...
$this->widget('bootstrap.widgets.TbNav', array(
    ...
    'items' => array(
            ...
            array('label'=>'<span class="menu-text">' . strtoupper(Yii::t('menu', 'Sale')) . ' (F2) ' . '</span>', 'icon'=>'menu-icon fa fa-shopping-cart', 'url'=>Yii::app()->urlManager->createUrl('saleItem/index'), 'active'=>$this->id .'/'. $this->action->id=='saleItem/index','visible'=>Yii::app()->user->checkAccess('sale.edit')),
            array('label'=>'<span class="menu-text">' . strtoupper(Yii::t('menu', 'Report')) .'</span>', 'icon'=>'menu-icon fa fa-signal', 'url'=>Yii::app()->urlManager->createUrl('report/reporttab'), 
            ...
            array('label'=>'<span class="menu-text">'. strtoupper(Yii::t('menu','Settings')) . '</span>', 'icon'=>'menu-icon fa fa-cogs','url'=>Yii::app()->urlManager->createUrl('settings/index'),
                    'active'=>$this->id=='employee' ||  $this->id=='settings' || strtolower($this->id)=='default' || $this->id=='store' ||  $this->id=='zone' ||  $this->id=='location' || $this->id=='priceTier' || $this->id=='giftcard',
                    'visible'=>Yii::app()->user->checkAccess('store.update'),
                           'items'=>array(
                               ...
                               array('label'=>Yii::t('menu','Zone'),'icon'=> TbHtml::ICON_GLOBE, 'url'=>Yii::app()->urlManager->createUrl('zone/admin'), 'active'=>$this->id .'/'. $this->action->id=='zone/admin',
                               ...
                               array('label'=>Yii::t('menu','Branch'),'icon'=> TbHtml::ICON_HOME, 'url'=>Yii::app()->urlManager->createUrl('location/admin'), 'active'=>$this->id .'/'. $this->action->id=='location/admin',
                               ...
                               array('label'=>Yii::t('menu','Gift Card'),'icon'=> TbHtml::ICON_GIFT, 'url'=>Yii::app()->urlManager->createUrl('giftcard/admin'), 'active'=>$this->id .'/'. $this->action->id=='giftcard/admin',
                               ...
                               array('label'=>Yii::t('menu','Price Tier'),'icon'=> TbHtml::ICON_ADJUST, 'url'=>Yii::app()->urlManager->createUrl('priceTier/admin'), 'active'=>$this->id .'/'. $this->action->id=='priceTier/admin',
